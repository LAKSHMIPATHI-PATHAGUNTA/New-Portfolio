...
import myImage from '../assets/PLP photo.jpg';
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between">
        <div className="text-center lg:text-left lg:w-1/2 mb-12 lg:mb-0 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center lg:justify-start space-x-4 mb-6">
            ...
            <a href="https://github.com/LAKSHMIPATHI-PATHAGUNTA" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-gray-900 transition-colors duration-300">
        ...
        <div className="lg:w-1/2 flex justify-center lg:justify-end px-4 sm:px-6 lg:px-8">
          <div className="relative">
            <div className="w-60 h-60 sm:w-80 sm:h-80 rounded-full bg-gradient-to-br from-pink-300 via-purple-500 to-blue-400 shadow-xl flex items-center justify-center">
              <img src={myImage} alt="Lakshmipathi" className="rounded-full w-52 h-52 sm:w-72 sm:h-72 object-cover border-4 border-white" />
            </div>
